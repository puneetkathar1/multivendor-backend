...
export default {
  ...
  async login(req, res, next) {
    ...
    return res.status(200).json({ success: true, token, email: req.user.email })
  },
      ...
      db.user
        ...
        .then((user) => {
          ...
          return res.status(401).json({
            ...
            redirect: false,
            msg:
              'Jankpur Grocerry account with that sign-in information does not exist. Try again or create a new account.',
          })
        })
    }
  },
